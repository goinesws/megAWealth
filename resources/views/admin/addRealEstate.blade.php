...
<body>
    ...
    {{-- form --}}
    <div style="border-style: solid; border-width: 1.5px; border-color:#106cfc; border-radius: 5px; height: 580px; width: 700px; margin: auto; margin-top: 5%; padding: 3%; margin-bottom: 5%;">
